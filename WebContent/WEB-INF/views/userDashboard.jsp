              ...
              <div class="card-body">
                <div class="d-flex">
                     <table class="table table-striped table-valign-middle">
                      ...
                      <tbody>
                        <c:forEach items="${currentdateemployeetimesheetList}" var="record">
                         <tr>
                           <td width="60" align="center">
                           <img src="dist/img/default-150x150.png" alt="Task 1" class="img-circle img-size-32 mr-2">
                           ${record.srNo}
              ...
              <div class="card-body">
                <div class="d-flex">
                     <table class="table table-striped table-valign-middle">
                      ...
                      <tbody>
                        <c:forEach items="${objectiveList}" var="record">
                         <tr>
                           <td width="60" align="center">
                           <img src="dist/img/default-150x150.png" alt="Objective" class="img-circle img-size-32 mr-2">
                           ${record.srNo}
                       </td>
                       <td width="60" align="center">${record.employee.username}</td>
