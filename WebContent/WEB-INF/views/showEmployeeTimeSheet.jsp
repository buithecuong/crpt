                 ...
                 <center><h1>List of Timesheet</h1></center>
                   <table border=1 frame=void rules=rows class="table" style="width: 300px" align="center">
                     ...
                     <tr>
                       ...
                       <td width="60" align="center"><a href="editTimeSheet?id=${record.srNo}">Edit</a>/<a href="deleteEmployeeTimeSheet?id=${record.srNo}" onclick="return confirm('Do you really want to delete?')">Delete</a></td>
                     </tr>
                  </c:forEach>
                </table>
                <br>
